...
for iMethod = 1:nMethod
    ...
    iterations(iMethod, 1:length(log.iterations), 1) = log.iterations;
    iterations(iMethod, 1:length(log.iterations), 2) = log.iterations;
...
cstColor = 0.2;
dimColor = [get_nice_color('b')-cstColor;get_nice_color('b');...
    get_nice_color('r')-cstColor;get_nice_color('r')];
% ;...

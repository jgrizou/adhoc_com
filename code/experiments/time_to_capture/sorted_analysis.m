...
load(fullfile(analysisFolder, 'noCom_random.mat'))
noComLog = log;

load(fullfile(analysisFolder, 'withCom_random.mat'))
withComLog = log;
...
%%
load(fullfile(analysisFolder, 'noCom_escape.mat'))
noComLog = log;

load(fullfile(analysisFolder, 'withCom_escape.mat'))
withComLog = log;

function partialObsComPredatorsTeamsStructs = generate_partial_obs_com_predators_teams_one_muted(allCardinalOrders, allComTypes, allComMappings, allComNoiseLevels)
...
for i = 1:nCombination
        ...
        partialObsComPredatorsTeamsStructs{i}{1} = PartialObsAgentMute(cardinalOrder(1), comType, comMapping, comNoiseLevel);

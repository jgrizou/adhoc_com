function partialObsComPredatorsTeamsStructs = generate_partial_obs_com_predators_teams(allCardinalOrders, allComTypes, allComMappings, allComNoiseLevels)
...
for i = 1:nCombination
        ...
        partialObsComPredatorsTeamsStructs{i}{1} = PartialObsAgentCom(cardinalOrder(1), comType, comMapping, comNoiseLevel);

...
while ~adhocDomain.is_prey_locked_at_locking_state()
    ...
    agentsActions = adhocDomain.collect_agents_actions(rec);  
    adhocDomain.apply_agents_actions(agentsActions, ordering)      
    
    %% update hypothesis proba
    adhocDomain.agents{1}.update_hypothesis_proba(domainState, adhocDomain.get_domain_state(), ordering, rec)    

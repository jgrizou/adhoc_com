...
\end{eqnarray}
%
With this planning strategy, once the correct hypothesis is identified, the ad hoc agent will mimic the default behavior of the agent it replaces.% Nothing limits us to the use of this policy and more advanced planning strategies -- which have already been shown to be beneficial in this kind of scenario \cite{barrett2011empirical} -- could be considered.
